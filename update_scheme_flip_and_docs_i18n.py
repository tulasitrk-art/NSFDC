...
LOCALES_DIR = r"c:\Users\TRK\OneDrive\Documents\NSFDC(SIH2026)\nsfdc-concessional-portal\frontend\src\locales"

translations = {
    "en": {
        "viewDocs": "View Required Documents (Flip Card 🔄)",
        "flipBack": "↺ Flip Back to Overview",
        ...
        "docs": {
            "doc_caste": "SC Community Caste Certificate (Revenue Dept / Tahsildar)",
            "doc_aadhaar": "Aadhaar Card (Linked with Active Mobile Number)",
            "doc_income": "Income Certificate / Declaration (Family Income ≤ ₹ 5,00,000 / Year)",
            ...
            "doc_marksheets": "10th, 12th & Degree Marksheets / Academic Transcripts",
            "doc_visa": "Valid Student Visa & Passport Copy (For Overseas Studies)",
            "doc_shg": "SHG Group Resolution / Female Entrepreneur Declaration",
            "doc_quotation": "Trade Quotation / Machinery Equipment Estimate",
            "doc_sanitation": "Sanitation Worker ID / Municipality ULB Identification Certificate",
            "doc_green": "Solar Equipment / E-Vehicle Quotation & Commercial Driving License",
            ...
            "doc_agri": "Agricultural Land Record (7/12 Extract / Patta) or Vet Certificate"
        },
        "note_moratorium": "Includes repayment moratorium period before EMI starts.",
        "note_dbt": "Direct DBT disbursement to beneficiary bank account.",
        "note_zero_fee": "Zero processing fees & no middlemen required."
    },
    "hi": {
        "viewDocs": "आवश्यक दस्तावेज देखें (कार्ड पलटें 🔄)",
        "flipBack": "↺ विवरण पर वापस जाएं",
        ...
        "note_moratorium": "ईएमआई शुरू होने से पहले पुनर्भुगतान अवकाश (मोराटोरियम) शामिल।",
        "note_dbt": "डीबीटी के माध्यम से सीधे बैंक खाते में ऋण वितरण।",
        "note_zero_fee": "शून्य प्रोसेसिंग शुल्क एवं कोई बिचौलिया नहीं।"
    },
    "te": {
        "viewDocs": "కావలసిన పత్రాలు చూడండి (కార్డు తిప్పండి 🔄)",
        "flipBack": "↺ వివరాలకు తిరిగి వెళ్లండి",
        ...
        "applyForThisScheme": "ఈ పథకం కోసం దరఖాస్తు చేసుకోండి →",
        "docs": {
        ...
        "note_dbt": "లబ్ధిదారుని బ్యాంక్ ఖాతాకు నేరుగా DBT ద్వారా నిధుల జమ.",
        "note_zero_fee": "జీరో ప్రాసెసింగ్ ఫీజు మరియు ఎలాంటి మధ్యవర్తులు లేరు."
    },
    "ta": {
        "viewDocs": "தேவையான ஆவணங்களைக் காண்க (அட்டையைத் திருப்புங்கள் 🔄)",
        "flipBack": "↺ கண்ணோட்டத்திற்குத் திரும்பு",
        ...
        "note_moratorium": "EMI தொடங்குவதற்கு முன் தவணைக் கால சலுகை (Moratorium) உண்டு.",
        "note_dbt": "DBT மூலம் நேரடியாக வங்கிக் கணக்கில் கடன் தொகை வரவு.",
        "note_zero_fee": "பூஜ்ஜிய செயலாக்கக் கட்டணம் மற்றும் இடைத்தரகர்கள் இல்லை."
    },
    "kn": {
        "viewDocs": "ಅಗತ್ಯ ದಾಖಲೆಗಳನ್ನು ವೀಕ್ಷಿಸಿ (ಕಾರ್ಡ್ ಫ್ಲಿಪ್ ಮಾಡಿ 🔄)",
        "flipBack": "↺ ವಿವರಗಳಿಗೆ ಹಿಂತಿರುಗಿ",
        ...
        "note_moratorium": "ಇಎಂಐ ಪ್ರಾರಂಭವಾಗುವ ಮುನ್ನ ಮರುಪಾವತಿ ರಜೆ (ಮೊರಟೋರಿಯಂ) ಲಭ್ಯವಿದೆ.",
        "note_dbt": "ಡಿಬಿಟಿ ಮೂಲಕ ನೇರವಾಗಿ ಬ್ಯಾಂಕ್ ಖಾತೆಗೆ ಸಾಲ ವರ್ಗಾವಣೆ.",
        "note_zero_fee": "ಯಾವುದೇ ಪ್ರೊಸೆಸಿಂಗ್ ಶುಲ್ಕವಿಲ್ಲ ಮತ್ತು ಮಧ್ಯವರ್ತಿಗಳಿಲ್ಲ."
    },
    "bn": {
        "viewDocs": "প্রয়োজনীয় নথি দেখুন (কার্ড ফ্লিপ করুন 🔄)",
        "flipBack": "↺ বিবরণে ফিরে যান",
        ...
        "note_moratorium": "ইএমআই শুরুর আগে ঋণ পরিশোধের অবকাশ (মোরেটোরিয়াম) সুবিধা।",
        "note_dbt": "সরাসরি ডিবিটি-র মাধ্যমে ব্যাঙ্ক অ্যাকাউন্টে অর্থ প্রদান।",
        "note_zero_fee": "কোনো প্রসেসিং ফি নেই এবং কোনো মধ্যস্থতাকারী নেই।"
    },
    "mr": {
        "viewDocs": "आवश्यक कागदपत्रे पहा (कार्ड उलटा 🔄)",
        "flipBack": "↺ माहितीवर परत जा",
        ...
        "note_moratorium": "ईएमआई सुरू होण्यापूर्वी परतफेड सवलत (मोरेटोरियम) कालावधी.",
        "note_dbt": "थेट डीबीटीद्वारे लाभार्थीच्या बँक खात्यात कर्ज वितरण.",
        "note_zero_fee": "शून्य प्रक्रिया शुल्क आणि कोणतेही मध्यस्थ नाहीत."
    },
    "gu": {
        "viewDocs": "જરૂરી દસ્તાવેજો જુઓ (કાર્ડ ફ્લિપ કરો 🔄)",
        "flipBack": "↺ પાછા વિગતો પર જાઓ",
        ...
        "note_moratorium": "EMI શરૂ થતાં પહેલાં મોરેટોરિયમ (હપ્તા મુક્તિ) સમયગાળો સામેલ.",
        "note_dbt": "સીધા ડીબીટી (DBT) દ્વારા બેંક ખાતામાં નાણાં જમા.",
        "note_zero_fee": "ઝીરો પ્રોસેસિંગ ફી અને કોઈ વચેટિયા વગર સહાય."
    }
}
...
def update_locales():
    for lang, data in translations.items():
        ...
        for k, v in data.items():
            if k == "docs" and "docs" in locale_json["schemes"]:
