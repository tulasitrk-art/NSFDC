    ...
    <footer className="bg-[#001529] text-white border-t-4 border-gov-saffron">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="space-y-3">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-base text-white tracking-tight">SAMRIDDHI Portal</span>
          </div>
          <p className="text-xs text-slate-300 leading-relaxed">
            SAMRIDDHI is the unified National Concessional Credit & Welfare Portal uniting Central Apex Corporations (NSFDC, NSTFDC, NBCFDC, NMDFC, NHFDC), Central Ministries, and State Channelizing Agencies across 36 States & UTs to deliver subsidized welfare credit to all eligible citizens.
          </p>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-xs text-slate-300">
            ...
            <li><Link href="/schemes" className="hover:text-gov-saffron transition-colors">Adivasi Mahila Sashaktikaran Yojana (AMSY)</Link></li>
            <li><Link href="/schemes" className="hover:text-gov-saffron transition-colors">New Swarnima Scheme (OBC-NCL)</Link></li>
            <li><Link href="/schemes" className="hover:text-gov-saffron transition-colors">Divyangjan Swavalamban (PwD)</Link></li>
            <li><Link href="/schemes" className="hover:text-gov-saffron transition-colors">Virasat Scheme for Minorities</Link></li>
          </ul>
        </div>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-xs text-slate-300">
            ...
            <li><a href="https://tribal.nic.in" target="_blank" rel="noreferrer" className="hover:text-gov-saffron transition-colors flex items-center space-x-1"><span>Ministry of Tribal Affairs</span><ExternalLink className="w-3 h-3"/></a></li>
            <li><a href="https://minorityaffairs.gov.in" target="_blank" rel="noreferrer" className="hover:text-gov-saffron transition-colors flex items-center space-x-1"><span>Ministry of Minority Affairs</span><ExternalLink className="w-3 h-3"/></a></li>
        ...
        <div className="space-y-3">
          <h4 className="text-sm font-bold text-gov-saffron uppercase tracking-wider border-b border-white/10 pb-1">
            National Portal Desk
          </h4>
          <div className="space-y-2 text-xs text-slate-300">
            <div className="flex items-start space-x-2">
              <MapPin className="w-4 h-4 text-gov-saffron shrink-0 mt-0.5" />
              <span>Scope Minar & Shastri Bhawan, Central Secretariat, New Delhi - 110001</span>
            </div>
            <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span>support-samriddhi@gov.in</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#000d1a] border-t border-white/10 py-4 text-center text-xs text-slate-400">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-2">
          <div>
            © {new Date().getFullYear()} SAMRIDDHI – Unified National Concessional Credit & Welfare Portal, Govt. of India. All Rights Reserved.
          </div>
